...
class Block(nn.Module):
    ...
    def __init__(self, n_embd, n_head): # n_embd: embedding dimensions, n_head: number of heads we'd like
        super().__init__()
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self,):
        ...
        # self.sa_heads = MultipleHeadAttention(4,n_embd//4) # i.e. 4 heads of 8-dimensional self-attention
        # self.ffwd = FeedForward(n_embd)
    ...
    def forward(self, idx, targets= None):
        ...
        x = self.ln_f(x) # (B,T,C)
        logits = self.lm_head(x) # B, T, vocad_size
